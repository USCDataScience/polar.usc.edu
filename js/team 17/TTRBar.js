...
function drawFPBarChart(tabId,path,minMaxFlag){
    ...
    var tip = d3.tip()
      ...
      .offset([-10, 0])
      .html(function(d) {
    return "<strong>Line: <span style='color:red'>"+ d.letter+"</span> TTR: </strong> <span style='color:red'>" + d.frequency + "</span>";
  })
    ...
    d3.tsv("TTRdata.tsv", type, function(error, data) {
     console.log(data);
